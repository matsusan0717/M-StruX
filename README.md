...
ご利用前に [利用規約](https://blogger-template-m-strux.blogspot.com/p/terms-of-service.html) をご確認ください。
...
- 2026.05.13｜2.0.1｜一覧ページ1ページあたりの件数 / サイドバーの新着記事の件数を設定に追加
- 2026.05.13｜2.0.0｜一覧ページのページネーションシステムを全面刷新 （記事一覧 / ラベル / アーカイブ / 検索一覧）
- 2026.05.12｜1.0.7｜画像ライトボックスの修正
- 2026.05.11｜1.0.6｜コンタクトフォーム用のガジェット追加
- 2026.05.11｜1.0.5｜任意ページの1カラム化の際、サイドバーのタブが動作していなかった問題を修正
- 2026.05.10｜1.0.4｜固定ページでページ送り / コメント欄が表示されていた問題を修正
- 2026.05.10｜1.0.3｜人気記事・新着記事 ページ表示条件分岐をb:ifからスクリプトに変更 CSSの調整
- 2026.05.08｜1.0.2｜関連記事周り調整 / ブログタイトルの見出し構造の修正
...
© matsusan — [https://blogger-template-m-strux.blogspot.com/](https://blogger-template-m-strux.blogspot.com/)
