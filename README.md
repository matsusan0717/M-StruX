...
- 2026.05.20｜2.2.3｜記事ページの画像をWebP化、遅延読み込みに対応
- 2026.05.19｜2.2.2｜サムネイルがない画像のスケルトンアニメーションが止まらない問題を修正
- 2026.05.18｜2.2.1｜アイコンを Font Awesome から SVG へ統一
- 2026.05.17｜2.2.0｜404ページ追加
- 2026.05.17｜2.1.2｜Googleアドセンスが表示されない問題を修正
- 2026.05.16｜2.1.0｜検索結果ページネーションの問題点を修正
